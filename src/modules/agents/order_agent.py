...
from config.app_config import ChatbotConfig as cc
from utils.response import get_client, get_chat_response
from utils.common import double_check_json_output
...
class OrderTakingAgent:
    def __init__(self, recommendation_agent):
        ...
        logging.info('Initialize order taking agent ...')
    ...
    def get_response(self, messages):
        ...
        system_prompt = """
        You are a customer support Bot for a coffee shop. Here is the menu for this coffee shop:
